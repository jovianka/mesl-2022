...
export default function NavigationBar() {
  ...
  return (
    <Navbar bg="dark" variant="dark" expand="sm" className="NavigationBar sticky-top shadow">
      <Container>
        <Navbar.Brand>
          <img src={MESLIcon} alt="MESL Logo" width="48" height="48" />
        </Navbar.Brand>
        ...
        <Navbar.Collapse id="navbar-nav">
          ...
          <Nav className="d-flex flex-row ms-auto justify-content-center">
            <Nav.Link href="https://www.instagram.com" className="p-2">
            ...
            <Nav.Link href="https://www.youtube.com" className="p-2">
            ...
            <Nav.Link href="https://www.whatsapp.com" className="p-2">
